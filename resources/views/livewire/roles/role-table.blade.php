      ...
      <div class="overflow-hidden sm:px-6 lg:px-8">
          ...
          class="min-w-full text-center text-sm font-light text-surface">
              ...
              @foreach ($roles as $key => $role)
                   <tr wire:key.live="{{$role->id}}" class="border-b border-neutral-200 dark:border-white/10">
                       ...
                       <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-700">
                                    ...
                                    <button @click="$dispatch('dispatch-delete-role', { id: '{{ Crypt::encryptString($role->id) }}', name: '{{$role->name}}' })" class="px-3 py-1 bg-red-600 dark:bg-red-700 text-white rounded">
