                        ...
                        <div>
                            <div class=" flex items-center">
                                <div class="bg-white rounded-sm shadow-md p-6 my-6 text-center">
                                    <img style="width: 20%" class="pl-14 w-15 rounded-full mb-4"
                                         src="https://spacema-dev.com/elevate/assets/images/team/1.jpg"
                                         alt="Number one"
                                    >
                                    <p class="mt-4 align-super text-gray-500 text-sm leading-relaxed">{{$candidate->quotation}}</p>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <button
                                            ...
                                            <i class='fa-regular fa-circle-dot fa-beat-fade'>&ensp;{{ $vote_count }} &ensp;</i>
                                            Vote(s)
                                        </button>
                                    </div>
                                </div>
