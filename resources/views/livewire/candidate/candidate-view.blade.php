<div>
    <x-dialog-modal wire:model.live="ViewCandidateModal" submit="save">
 ...
 <div class="grid grid-cols-12 gap-4">
            ...
            <div class="mt-2 col-span-12">
                    <x-label for="form.post" value="{{ __('Campaign Post') }}" />
                         <select disabled id="form.post" wire:model="form.post" class="mt-1 block w-full  text-black-700 focus:ring-indigo-500 rounded-md shadow-sm" autocomplete="form.post">
        ...
        <x-slot name="footer">
            <x-secondary-button @click="$wire.set('ViewCandidateModal', false)" wire:loading.attr="disabled">
